...
class FlowDataset(ABC, VisionDataset):
    ...
    def __init__(self, root: Union[str, Path], transforms: Optional[Callable] = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
...
class Sintel(FlowDataset):
    ...
    """
    def __init__(self, root: Union[str, Path], split: str = ..., pass_name: str = ..., transforms: Optional[Callable] = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
...
class KittiFlow(FlowDataset):
    ...
    """
    _has_builtin_flow_mask = ...
    def __init__(self, root: Union[str, Path], split: str = ..., transforms: Optional[Callable] = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
...
class FlyingThings3D(FlowDataset):
    ...
    Args:
        ...
        loader (callable, optional): A function to load an image given its path.
            ...
            ``torchvision.io.decode_image`` for decoding image data into tensors directly.
    """
    def __init__(self, root: Union[str, Path], split: str = ..., pass_name: str = ..., camera: str = ..., transforms: Optional[Callable] = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
