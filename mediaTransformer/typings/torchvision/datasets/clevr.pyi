...
class CLEVRClassification(VisionDataset):
    ...
    _URL = ...
    _MD5 = ...
    def __init__(self, root: Union[str, pathlib.Path], split: str = ..., transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., download: bool = ..., loader: Callable[[Union[str, pathlib.Path]], Any] = ...) -> None:
        ...
