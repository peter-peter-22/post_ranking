...
class FGVCAircraft(VisionDataset):
    ...
    """
    _URL = ...
    def __init__(self, root: Union[str, Path], split: str = ..., annotation_level: str = ..., transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., download: bool = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
