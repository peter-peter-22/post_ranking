...
class INaturalist(VisionDataset):
    ...
    """
    def __init__(self, root: Union[str, Path], version: str = ..., target_type: Union[List[str], str] = ..., transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., download: bool = ..., loader: Optional[Callable[[Union[str, Path]], Any]] = ...) -> None:
        ...
