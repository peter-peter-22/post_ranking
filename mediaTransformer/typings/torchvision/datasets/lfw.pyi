...
class _LFW(VisionDataset):
    ...
    annot_file = ...
    names = ...
    def __init__(self, root: Union[str, Path], split: str, image_set: str, view: str, transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., download: bool = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
...
class LFWPeople(_LFW):
    ...
    """
    def __init__(self, root: str, split: str = ..., image_set: str = ..., transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., download: bool = ..., loader: Callable[[str], Any] = ...) -> None:
        ...
